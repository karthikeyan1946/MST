...
import './InformalEvents.css'
import sportscover from './sportscover.jpg'
import { useNavigate } from 'react-router-dom';
function InformalEvents() {
...
{/* <div className='main-photo'>Events </div> */}
      ...
      <div className='large'>
            <div className='medium1'>
                    ...
                    <div className='small1'>
                        ...
                        <div className='matter1'><h2>Cricket</h2>{matter} <button className='register-button'>Register</button></div>
                    </div>


                    <div className='small2'>
                        <div className='matter2'><h2>Cricket</h2>{matter}<button className='register-button'>Register</button></div>
